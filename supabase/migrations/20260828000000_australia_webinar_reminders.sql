-- Re-point the webinar reminder crons at the Study in Australia webinar on
-- 28 August 2026, 7:00 PM IST.
--
-- The jobs were last rescheduled in 20260814000000_commonwealth_webinar_reminders.sql
-- to '30 12 14 8 *' / '30 13 14 8 *'. Those have fired and would not run again
...
-- now "Study in Australia Webinar (28 August 2026)". If the function still
-- carries the Commonwealth name, these runs will find nobody to mail.
--
