-- Re-point the webinar reminder crons at "The 7 Reasons Brilliant Students Get
-- Rejected by Top Universities" webinar on 11 September 2026, 7:00 PM IST.
--
-- The jobs were last rescheduled in 20260828000000_australia_webinar_reminders.sql
-- to '30 12 28 8 *' / '30 13 28 8 *'. Those have fired and would not run again
-- until next year, so both are rescheduled here. The trigger, the send-tracking
-- columns and the confirmation path are unchanged.
--
-- Must be paired with a redeploy of send-webinar-email, whose WEBINAR_NAME is
-- now "7 Reasons Brilliant Students Get Rejected Webinar (11 September 2026)".
-- If the function still carries the Australia name, these runs will find nobody
-- to mail.
--
