...
const AchieverCard = ({ a }: { a: typeof achievers[0] }) => (
  <div style={{ width: CARD_W, flexShrink: 0, display:"flex",alignItems:"stretch",borderRadius:14,overflow:"hidden",background:"rgba(6,93,199,0.06)",border:"1px solid rgba(97,162,254,0.12)",minHeight:130 }}>
