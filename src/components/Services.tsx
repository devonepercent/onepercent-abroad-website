...
const Services = () => (
  <section id="services" style={{ background:"#142444",padding:"100px 60px",borderTop:"1px solid rgba(97,162,254,0.06)",fontFamily:"'DM Sans',sans-serif",color:"#fff" }}>
    <div style={{ maxWidth:1000,margin:"0 auto" }}>
      ...
      <div style={{ textAlign:"center" }}>
        <Link
          to="/get-started"
          style={{ display:"inline-block",background:"#fff",color:"#0a1628",padding:"14px 44px",borderRadius:60,fontSize:14,fontWeight:600,textDecoration:"none",transition:"transform 0.2s,box-shadow 0.3s" }}
          onMouseOver={e => { e.currentTarget.style.transform="scale(1.05)"; e.currentTarget.style.boxShadow="0 8px 32px rgba(59,130,246,0.3)"; }}
...
const ServiceCard = ({ s }: { s: typeof services[0] }) => (
  <div
    style={{ background:"rgba(97,162,254,0.04)",border:"1px solid rgba(97,162,254,0.1)",borderRadius:16,padding:"36px 32px",transition:"background 0.3s,transform 0.25s",cursor:"default" }}
    onMouseOver={e => { (e.currentTarget as HTMLDivElement).style.background="rgba(97,162,254,0.08)"; (e.currentTarget as HTMLDivElement).style.transform="translateY(-4px)"; }}
    onMouseOut={e  => { (e.currentTarget as HTMLDivElement).style.background="rgba(97,162,254,0.04)"; (e.currentTarget as HTMLDivElement).style.transform="translateY(0)"; }}
  >
