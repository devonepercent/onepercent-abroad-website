...
const TestimonialCard = ({ t }: { t: typeof testimonials[0] }) => (
  <div style={{ background:"#021488",border:"1px solid rgba(97,162,254,0.1)",borderRadius:16,padding:"36px 32px",display:"flex",flexDirection:"column",height:"100%",boxSizing:"border-box" }}>
