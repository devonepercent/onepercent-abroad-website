  ...
  return (
    <section className="w-full py-24 sm:py-32 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-10 lg:px-20">
        ...
        <div className="relative flex overflow-hidden before:content-[''] before:absolute before:left-0 before:top-0 before:w-32 before:h-full before:bg-gradient-to-r before:from-background before:to-transparent before:z-10 after:content-[''] after:absolute after:right-0 after:top-0 after:w-32 after:h-full after:bg-gradient-to-l after:from-background after:to-transparent after:z-10">
          <div className="flex animate-marquee whitespace-nowrap items-center">
            {logos.map((logo, idx) => (
              <div key={`${logo.name}-1-${idx}`} className="inline-flex items-center justify-center mx-16 sm:mx-20 lg:mx-32">
                <img
          ...
          <div className="absolute top-0 flex animate-marquee2 whitespace-nowrap items-center">
            {logos.map((logo, idx) => (
              <div key={`${logo.name}-2-${idx}`} className="inline-flex items-center justify-center mx-16 sm:mx-20 lg:mx-32">
                <img
                  className="h-20 sm:h-28 md:h-32 lg:h-40 w-auto object-contain"
                  alt={`${logo.name} Logo`}
                  src={logo.url}
